...
test {
    ...
    std.testing.refAllDecls(@import("system/chest.zig"));
    std.testing.refAllDecls(@import("system/control.zig"));
    std.testing.refAllDecls(@import("system/dialog.zig"));
    std.testing.refAllDecls(@import("system/farm.zig"));
    std.testing.refAllDecls(@import("system/interact.zig"));
    ...
    std.testing.refAllDecls(@import("system/rest.zig"));
