...
//
//    Cmdline:
//        sokol-shdc -i .\src\shader\single.glsl -o .\src\shader\single.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
...
//            Bind slot: SMP_smp => 0
//
pub const ATTR_single_position = 0;
...
//    void vert_main()
//    {
//        gl_Position = mul(position, _19_vp);
//        color = color0;
//        uv = texcoord0;
//    }
//
...
const vs_source_hlsl5 = [935]u8 {
    ...
    0x69,0x6f,0x6e,0x2c,0x20,0x5f,0x31,0x39,0x5f,0x76,0x70,0x29,0x3b,0x0a,0x20,0x20,
    0x20,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x30,
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x74,0x65,0x78,0x63,0x6f,
...
//    {
//        main0_out out = {};
//        out.gl_Position = _19.vp * in.position;
//        out.color = in.color0;
//        out.uv = in.texcoord0;
//        return out;
//    }
//
//
const vs_source_metal_macos = [604]u8 {
...
const vs_source_wgsl = [972]u8 {
    ...
    0x74,0x34,0x78,0x34,0x66,0x20,0x3d,0x20,0x78,0x5f,0x31,0x39,0x2e,0x76,0x70,0x3b,
