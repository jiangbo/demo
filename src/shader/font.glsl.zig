...
//
//    Cmdline:
//        sokol-shdc -i .\src\shader\font.glsl -o .\src\shader\font.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
//    Shader program: 'font':
...
//            ATTR_font_vertex_rotation => 1
//            ATTR_font_vertex_size => 2
...
pub const ATTR_font_vertex_rotation = 1;
pub const ATTR_font_vertex_size = 2;
...
pub fn fontImageSlot(img_name: []const u8) ?usize {
